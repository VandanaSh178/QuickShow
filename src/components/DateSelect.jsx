...
import { ChevronLeftIcon, ChevronRightIcon } from 'lucide-react' // ✅ You forgot this import
      ...
      relative p-8 bg-primary/10 border-primary/20 rounded-lg'>
        ...
        <div>
          ...
          <div className='flex items-center gap-6 text-sm mt-5'>
            ...
            {/* ❌ FIXED: Use div instead of span for containing buttons */}
            ...
            <ChevronRightIcon width={28} /> {/* ✅ Was missing */}
          </div>
        </div>
